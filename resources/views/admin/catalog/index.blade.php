            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        {{-- <a href="{{ url('catalogs/create') }}" @click="addData()" --}} <a href="javascript:void(0)"
                            @click="addData()" class="btn btn-sm btn-primary pull-left">Create New
                            Catalog</a>
                    </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{date ('H:i:s - d M Y' , strtotime($data->updated_at))}}
                                    </td>
